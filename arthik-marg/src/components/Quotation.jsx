...
newItems[index].amount = (newItems[index].quantity * newItems[index].rate) - newItems[index].discount;
setItems(newItems);
...
e.preventDefault();
console.log({ party, quotationNo, invoiceDate, items, notes, image });
...
return ( <div className="fixed inset-0 flex items-center justify-center bg-black bg-opacity-50 z-50 overflow-auto p-4"> <div className="w-full max-w-4xl p-6 bg-white dark:bg-gray-800 rounded shadow relative">
{/* Close Button */}
<button
onClick={() => navigate(-1)}
...
```
    <h2 className="text-2xl font-bold mb-4 text-gray-800 dark:text-gray-100">Create Quotation</h2>

    <form onSubmit={(e) => handleSubmit(e)} className="space-y-4">

      {/* Select Party */}
      <div>
        <label className="block text-gray-700 dark:text-gray-200 font-semibold mb-1">Select Party</label>
        <input
          type="text"
      ...
      <div className="flex gap-4">
        <div className="flex-1">
          <label className="block text-gray-700 dark:text-gray-200 font-semibold mb-1">Quotation No</label>
        ...
        <div className="flex-1">
          <label className="block text-gray-700 dark:text-gray-200 font-semibold mb-1">Invoice Date</label>
          <input
            type="date"
            value={invoiceDate}
