...
export function SalesReturnPage({ sidebarOpen }) {
    ...
    >
      <div className="max-w-lg w-full flex flex-col items-center text-center space-y-6">
        ...
        <h2 className="text-2xl font-bold text-gray-800">
          Create Your First Sales Return
        </h2>

        <p className="text-gray-500 text-base max-w-md">
          Click on the Create Sales Return button and start managing your sales returns.
        </p>
