...
export default function AddSales() {
  ...
  const updateItem = (index, field, value) => {
    ...
    const discount = Number(updated[index].discount); // IN %

    const total = qty * rate;
    const discountAmount = (total * discount) / 100;

    updated[index].amount = total - discountAmount;
  ...
  return (
    <div className="max-w-5xl mx-auto bg-white shadow-xl rounded-xl p-6 my-6">
