...
export function PurchaseBillsPage({ sidebarOpen }) {
        ...
        <div className="relative flex flex-col items-center mb-4">
          <div className="w-40 h-40 bg-gray-100 rounded-full flex items-center justify-center">
            <div className="w-24 h-32 bg-white border-2 border-gray-200 rounded-lg flex flex-col items-center p-3 shadow-sm relative -top-2">
              ...
              <div className="w-full h-1 bg-gray-300 rounded mb-4"></div>
              <div className="w-3/4 h-1 bg-gray-200 rounded mb-2"></div>
              <div className="w-5/6 h-1 bg-gray-200 rounded mb-2"></div>
              <div className="w-2/3 h-1 bg-gray-200 rounded mb-2"></div>
              <div className="w-4/5 h-1 bg-gray-200 rounded mb-2"></div>
              <div className="w-3/4 h-1 bg-gray-200 rounded mb-2"></div>
